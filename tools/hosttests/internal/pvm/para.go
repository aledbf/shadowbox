...
const (
	...
	// PVM_EVENT_ENTRY_SUPERVISOR_OFFSET: supervisor events enter this far
	// past MSR_PVM_EVENT_ENTRY; user events enter at the MSR value.
	PVM_EVENT_ENTRY_SUPERVISOR_OFFSET = 512
...
const (
	...
	PVM_HC_IRQ_HLT           = PVM_HC_SPECIAL_BASE + 2
