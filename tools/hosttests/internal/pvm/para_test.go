...
var goConstants = map[string]uint64{
	...
	"PVM_VIRTUAL_MSR_MAX_NR":        PVM_VIRTUAL_MSR_MAX_NR,
	"PVM_VIRTUAL_MSR_MAX":           PVM_VIRTUAL_MSR_MAX,
	...
	"PVM_HC_SPECIAL_MAX_NR":         PVM_HC_SPECIAL_MAX_NR,
	"PVM_HC_SPECIAL_BASE":           PVM_HC_SPECIAL_BASE,
	"PVM_HC_SPECIAL_MAX":            PVM_HC_SPECIAL_MAX,
	"PVM_HC_LOAD_PGTBL":             PVM_HC_LOAD_PGTBL,
	"PVM_HC_IRQ_WIN":                PVM_HC_IRQ_WIN,
	"PVM_HC_IRQ_HALT":               PVM_HC_IRQ_HALT,
